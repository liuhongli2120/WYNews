...
- (void)viewDidLoad {
    ...
    //注册通知
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(didSelectDoc:) name:WYNewsListDidSelectedDocNotification object:nil];
...
#pragma mark - 监听通知
- (void)didSelectDoc:(NSNotification *)n {
